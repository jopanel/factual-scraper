<?php
		// THIS CODE MUST ONLY BE USED BY JOSEPH OPANEL. JOSEPH OPANEL DOES NOT GIVE ANYBODY PERMISSION TO RUN, MODIFY, OR COPY ANY PORTION OF THIS CODE FOR ANY REASON.
	...
	$buildcount = 0;
		foreach ($buildziparray as $call) {
			...
			if ($buildcount == 498) {
				sleep(61);
				$ch = curl_init();
				curl_setopt($ch, CURLOPT_URL, "http://www.datascrubber/test.php");
			...
			$query->field("category_ids")->in(144); // 144 is 	Retail > Fashion > Jewelry and Watches
